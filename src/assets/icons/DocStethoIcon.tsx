...
interface DocStethoIconProps extends SVGProps<SVGSVGElement> {
    size?: number;
}

const DocStethoIcon = ({ size, className = "w-full h-full", ...props }: DocStethoIconProps) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 120 120"
        ...
        className={className}
        role="img"
        aria-label="DocStetho"
        {...props}
    >
        <title>DocStetho</title>
